# https://github.com/neuraloperator/physics_informed/tree/d1835d1e6ee9d7969455ceb36040389a23d04d85
import os
import yaml
import random
...
from train_utils.datasets import NS3DDataset, KFDataset, McWilliams2DDataset
...
def subprocess(args):
    ...
    datasets = {
        'KF': KFDataset, 
        'NS': NS3DDataset,
        'NS2D': McWilliams2DDataset,
        'McWilliams2D': McWilliams2DDataset
    }
    ...
    if args.test:
        ...
        if dataname == 'McWilliams2D':
            testset = datasets[dataname](file_path=config['data']['paths'][0], 
        ...
        # Handle different dataset types
        if dataname == 'McWilliams2D':
            dataset = datasets[dataname](file_path=config['data']['paths'][0], 
                                         raw_res=config['data']['raw_res'],
